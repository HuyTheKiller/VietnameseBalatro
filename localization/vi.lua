return {
        ...
        Enhanced = {
            ...
            m_lucky = {
                ...
                text = {
                    ...
                    SMODS and "Xác suất {C:green}#6# trên #5#" or "Xác suất {C:green}#1# trên #5#{}",
                    "để nhận {C:money}$#4#"
                }
            }
        },
    ...
    misc = {
        ...
        dictionary = {
            ...
            b_vanilla_run_select = 'Khởi Tạo Trận Kiểu Vanilla',
            b_vanilla_run_select_info = 'Tuỳ chọn này bị bỏ qua nếu trang mới được mod thêm vào',
            b_run_select_reduce = 'Khởi Tạo Trận Hiệu Năng Cao',
            b_run_select_reduce_info = 'Giảm số lượng lá bài và loại bỏ hoạt ảnh',
            b_author = 'Người tạo',
			b_authors = 'Người tạo',
            b_unknown = 'Không rõ',
            ...
            run_select_locked_stake = "Bị Khoá",
            run_select_locked_stake_message = "Thắng bằng bộ bài này ở ",
            ...
            run_select_stake_choice = 'Chọn Cược',
            run_select_deck_choice_random = 'Bộ Bài Ngẫu Nhiên',
